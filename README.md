...
136 |[Single Number](https://leetcode.com/problems/single-number/description/) |[C](./algorithms/singleNumber/single-number.c) / [C++](./algorithms/singleNumber/single-number.cpp) / [Python](./algorithms/singleNumber/single-number.py) | Easy | Bit Manipulation
